              ...
              <Dropdown alignRight>
                <Dropdown.Toggle className="nav-link">
                  ...
                  <div className="nav-profile-text">
                    <p className="mb-1 text-black"><Trans>{this.props.user_details.username} ({this.props.user_details.role === 1 ? 'Admin' : this.props.user_details.role === 2 ? 'Agent' : 'unknown'})</Trans></p>
                  </div>
                </Dropdown.Toggle>
